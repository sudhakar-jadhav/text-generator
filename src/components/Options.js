...
const Options = (props) => {
    const { 
        paragraphs, tag, copiedCode, setCopiedCode,
    setIncludeHtml, includeHtml, setInputValue, setTag
    } = props
        ...
        <div className='wrapper'>
            <div className='optionsContainer'>
                <div className='paragraphs'>
                    <p>Paragraphs:</p>
                    <input type='number' min='1' max='10' defaultValue='1' onChange={e => setInputValue(e.target.value)}></input>
                </div>
                <div className='tags'>
                    <p>Tags:</p>
                    <select defaultValue={tag} onChange={e=>setTag(e.target.value)}>
                        ...
                        <option value='span'>&lt;span&g;t</option>
                    </select>
                </div>
