...
const App = () => {
  ...
  return <div className='App'>
    <Container>
    <Title />
    <Options paragraphs={paragraphs} tag={tag} copiedCode={copiedCode} setCopiedCode={setCopiedCode}
    setIncludeHtml={setIncludeHtml} includeHtml={includeHtml} setInputValue={setInputValue} setTag={setTag} />
